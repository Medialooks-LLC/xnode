...
echo   build-dev.bat msvc Debug xnode --build
echo   build-dev.bat clang-ninja
echo   build-dev.bat clang-ninja Debug xnode_unit_tests --build
echo   build-dev.bat clang-vs Debug xnode_complex_tests --build
echo.
echo Notes:
