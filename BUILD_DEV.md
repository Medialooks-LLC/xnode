...
This file documents the Conan-backed local build flows used by `xnode` developers.
...
Use [build-dev.bat](E:/work/xnode/build-dev.bat) from the repository root:
...
build-dev.bat
build-dev.bat msvc
build-dev.bat msvc Debug xnode --build
build-dev.bat clang-ninja
build-dev.bat clang-ninja Debug xnode_unit_tests --build
build-dev.bat clang-vs Debug xnode_complex_tests --build
```
